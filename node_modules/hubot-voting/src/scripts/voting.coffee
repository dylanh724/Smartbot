...
module.exports = (robot) ->
  ...
  robot.respond /start vote (.+)$/i, (msg) ->
    ...
    if robot.voting.votes?
      ...
      msg.send "@all Attention, vote started!"
      sendChoices(msg)
  ...
  robot.respond /vote (for )?(.+)$/i, (msg) ->
    ...
    if validChoice choice
      ...
      msg.send "#{sender} are you drunk?! That is not a valid choice!"
  ...
  sendChoices = (msg, results = null) ->
    ...
    if robot.voting.choices?
      ...
      msg.send "@all Hey guys! LOL, this one is must have been smoking something!! How are you asking for choices if there isn't a vote going on right now?! Go home, have some sleep!"
