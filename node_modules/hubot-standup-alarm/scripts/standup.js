...
module.exports = function(robot) {
    ...
    var STANDUP_MESSAGES = [
        "Standup time! Prepare your '1-2-3'",
        "Time for standup, y'all. Everyone ready up",
	...
	var A_Z = [
		" (A-Z today) -- Agung, want to start?",
		" (Z-A today) -- Let's start!"
	];
	var WED_MESSAGE = "Hangouts Meeting Time (Thu)!  https://goo.gl/kdo3Af";	
    ...
    function doStandup(room) {
        // Dylan -- room override for SL
		room = "66204_smartlaunch@conf.hipchat.com";
		
		// Standard msg
		console.log("Standup about to be called in room: " + room);
		var message = PREPEND_MESSAGE + _.sample(STANDUP_MESSAGES) + _.sample(A_Z);
		
		// Is wed meeting?
		var now = new Date();
		var day = now.getDay(); // 0 = Sun, 1 = Mon, 2 = Tue, 3 = Wed, 4 = Thu, 5 = Fri, 6 = Sun
		if (day == 4) { // Thu
			// Change to thu (if not, use standard above) special msg
			message = WED_MESSAGE + _.sample(A_Z);
		} 
