...
module.exports = function(robot) {
    ...
    var STANDUP_MESSAGES = [
        "Standup time! Prepare your '1-2-3' (A-Z today). Agung, want to start?",
        "Time for standup, y'all. Prepare your '1-2-3' (Z-A today).",
        "It's standup time once again (A-Z today)! Agung how about going 1st?",
        "Get up, stand up (it's time for our standup: Z-A today).",
        "Standup time. Get up, humans (A-Z today). Zagung--err--Agung, are you ready?",
        "Standup time! Now! Go go go! (Z-A today)."
    ];
	var WED_MESSAGE = "Meeting time (Wed)!  https://goo.gl/kdo3Af";	
    ...
    function doStandup(room) {
		...
		// Is wed meeting?
		var now = new Date();
		var day = now.getDay(); // 0 = Sun, 1 = Mon, 2 = Tue, 3 = Wed
		if (day == 3) {
			// Change to wed (if not, use standard above
			message = WED_MESSAGE;
		} 
