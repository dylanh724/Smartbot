...
module.exports = (robot) ->
  ...
  robot.hear /^asana:\s?(@\w+)? ([^#]*)\s?(#[\w-]+)?/i, (msg) ->
	...
	# msg.send "Debug: robot.hear..."
	# msg.send "asana api key = #{asana_api_key_}"
	# msg.send "assignee = #{assignee_name}"
	# msg.send "task name = #{task_name}"
	# msg.send "project name = #{project_name}"
      params = {
        data: {
          name: task_name,
