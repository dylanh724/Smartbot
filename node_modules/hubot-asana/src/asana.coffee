...
module.exports = (robot) ->
  robot.respond /asana: (.*)$/i, (msg) ->
    ...
    msg.send "You should be good to add Asana tasks now! Debug: robot.hear..."
	msg.send "asana api key = #{asana_api_key_} assignee = #{assignee_name} task name = #{task_name} project name = #{project_name}"
  ...
  robot.hear /^asana:\s?(@\w+)? ([^#]*)\s?(#[\w-]+)?/i, (msg) ->
	...
	#cb = "asana api key = #{asana_api_key_} assignee = #{assignee_name} task name = #{task_name} project name = #{project_name}"
